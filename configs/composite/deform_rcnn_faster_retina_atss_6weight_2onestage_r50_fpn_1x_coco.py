...
model = dict(
    ...
    roi_head=[dict(
        type='DeformRCNNDecHead',
        num_classes=80,
        in_channels=256,
        distance_mode='cost',
        distance_thresh=2.5,
        sync_cls_avg_factor=True,
        ignore_high_iou=True,
        proposal_drop_rate=0.5,
        loss_on_encoder=True,
...
dist_params = dict(backend='nccl', port=20915)
resume_from = 'work_dirs/composite/deform_rcnn_faster_retina_atss_6weight_2onestage_r50_fpn_3x_coco/epoch_10.pth'
