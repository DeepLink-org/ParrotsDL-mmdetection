...
model = dict(
    ...
    query_head=dict(
        type='CompositeDeformDETRHeadInstability',
        num_query=300,
        num_classes=80,
        in_channels=2048,
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/lustre/share/DSK/datasets/mscoco2017/' + 'annotations/instances_val2017.json',
...
save_epoch=10
dist_params = dict(backend='nccl', port=20916)
custom_hooks = [
    dict(
        type='SaveInstabilityHook',
        epoch=save_epoch,
        priority=48)
]
load_from = 'work_dirs/composite/deform_detr_anchor_feats_2atss_faster_1conv_6weight_2onestage_r50_fpn_1x_coco/epoch_'+str(save_epoch)+'.pth'
