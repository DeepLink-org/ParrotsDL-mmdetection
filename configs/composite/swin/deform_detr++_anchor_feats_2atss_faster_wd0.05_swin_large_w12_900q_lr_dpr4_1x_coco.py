...
pretrained = '/mnt/lustre/zongzhuofan/models/swin_large_patch4_window12_384_22k.pth'
# model settings
model = dict(
...
resume_from = 'work_dirs/composite/swin/deform_detr++_anchor_feats_2atss_faster_wd0.05_swin_large_w12_900q_lr_dpr4_3x_coco/epoch_10.pth'
