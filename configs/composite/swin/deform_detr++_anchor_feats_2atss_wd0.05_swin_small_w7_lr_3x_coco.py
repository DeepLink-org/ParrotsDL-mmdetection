...
pretrained = '/mnt/lustre/zongzhuofan/models/swin/swin_small_patch4_window7_224.pth'
# model settings
model = dict(
...
resume_from = 'work_dirs/composite/swin/deform_detr++_anchor_feats_2atss_wd0.05_swin_small_w7_lr_1x_coco/epoch_10.pth'
