...
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(filter_empty_gt=True, seg_prefix=data_root + 'stuff-segmentation/train2017/', pipeline=train_pipeline),
...
resume_from = 'work_dirs/composite/deform_detr_htc_retina_atss_r50_fpn_3x_coco/epoch_25.pth'
