...
model = dict(
    ...
    bbox_head=[dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=6.0),
        loss_bbox=dict(type='SmoothL1Loss', beta=0.11, loss_weight=4.5)),
        dict(
        type='ATSSHead',
        num_classes=80,
        in_channels=256,
...
resume_from = 'work_dirs/composite/deform_detr_faster_freeanchor_atss_6weight_2onestage_r50_fpn_3x_coco/latest.pth'
