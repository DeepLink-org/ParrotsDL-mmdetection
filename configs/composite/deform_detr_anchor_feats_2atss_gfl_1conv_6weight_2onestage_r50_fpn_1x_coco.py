...
model = dict(
    ...
    bbox_head=[dict(
        ...
        loss_cls=dict(
            ...
            beta=2.0,
            loss_weight=12.0),
        loss_dfl=dict(type='DistributionFocalLoss', loss_weight=3),
        reg_max=16,
        loss_bbox=dict(type='GIoULoss', loss_weight=24.0)),],
...
resume_from = 'work_dirs/composite/deform_detr_anchor_feats_2atss_gfl_1conv_6weight_2onestage_r50_fpn_3x_coco/epoch_10.pth'
