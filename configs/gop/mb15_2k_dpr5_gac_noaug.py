    ...
    dict(
        ...
        policies=[
            [
                dict(
                    type='Resize',
                    img_scale=[(640, 2304), (672, 2304), (704, 2304), (736, 2304), 
                            (768, 2304), (800, 2304), (832, 2304), (864, 2304), 
                            (896, 2304), (928, 2304), (960, 2304), (992, 2304), 
                            (1024, 2304), (1056, 2304), (1088, 2304), (1120, 2304), 
                            (1152, 2304), (1184, 2304), (1216, 2304), (1248, 2304), 
                            (1280, 2304), (1312, 2304), (1344, 2304), (1376, 2304)],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/gop/f_GAC_pseudo_L4-365w_adas_baidu-st_data_cls10_lg_coco.json',
        img_prefix=data_root + '',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + '/mnt/lustre/zongzhuofan/labels/gop/GAC_Test_coco_id10.json',
        img_prefix=data_root + '',
