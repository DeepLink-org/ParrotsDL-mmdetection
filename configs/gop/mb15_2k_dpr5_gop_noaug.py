...
model = dict(
    ...
    query_head=dict(
        ...
        in_channels=2048,
        max_pos_priors=300,
        use_labeled_loss=True,
        labeled_mask='/mnt/lustre/share_data/maqiang/obstacle/gop_gac10/gop_gac/f_GOP_GAC_pseudo_L4-365w_adas_baidu-st_data_cls10_lg.json',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            classes=classes,
            ann_file=data_root + '/mnt/lustre/zongzhuofan/labels/gop/f_GOP_GAC_pseudo_L4-365w_adas_baidu-st_data_cls10_lg_coco.json',
            img_prefix=data_root + '',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + '/mnt/lustre/zongzhuofan/labels/gop/GOP_Test_V3.3_MR_coco.json',
        img_prefix=data_root + '',
