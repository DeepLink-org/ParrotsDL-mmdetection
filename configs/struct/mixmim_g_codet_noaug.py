...
file_client_args = dict(
    backend='petrel',
    path_mapping=dict({
        'data/coco': 'sh1986:s3://RDBP1-2/struct',
    })
)
    ...
    dict(
        ...
        policies=[
            [
                dict(
                    type='Resize',
                    img_scale=[(640, 2200), (672, 2200), (704, 2200), (736, 2200), 
                            (768, 2200), (800, 2200), (832, 2200), (864, 2200), 
                            (896, 2200), (928, 2200), (960, 2200), (992, 2200), 
                            (1024, 2200), (1056, 2200), (1088, 2200), (1120, 2200), 
                            (1152, 2200), (1184, 2200), (1216, 2200), (1248, 2200), 
                            (1280, 2200), (1312, 2200), (1344, 2200), (1376, 2200)],
...
classes = ('pedestrian', 'cycer', 'vehicle', 'cyc')
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=1,
    train=dict(
        type='CowDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/struct_test/all_coco_900.json',
        img_prefix='data/coco/',
        pipeline=train_pipeline),
    val=dict(
        type='CowDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/struct_test/test_all_coco.json',
        img_prefix='',
    ...
    test=dict(
        ...
        img_prefix='',
        pipeline=test_pipeline))
evaluation = dict(metric='bbox', classwise=True, proposal_nums=[300, 300, 300], iou_thrs=[0.5])
...
evaluation = dict(interval=5000, metric='bbox', classwise=True, proposal_nums=[300, 300, 300], iou_thrs=[0.5])
...
load_from = None
resume_from = '/mnt/lustre/zongzhuofan/competition/mmdetection/work_dirs/struct/mixmim_g_codet_noaug/latest.pth'
#resume_from = '/mnt/lustre/zongzhuofan/competition/mmdetection/work_dirs/struct/mixmim_g_codet/latest.pth'
