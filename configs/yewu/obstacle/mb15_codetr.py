...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/obstacle/GAC_only_with_triangle_selected_new_coco.json',
        img_prefix='',
        pipeline=train_pipeline),
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/obstacle/GAC_Test_P0_selected_ceph_coco.json',
        img_prefix='',
