...
classes = ('Red','Yellow','Green','Black','Number')
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=1,
    train=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/ad_tlr/ad_5cls_all_add_v273-MB15v0.2_train_coco.json',
        img_prefix='',
        pipeline=train_pipeline),
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/ad_tlr/ad_tlr_day_part_all_test_coco.json',
        img_prefix='shlg:',
