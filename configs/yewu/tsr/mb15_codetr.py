    ...
    dict(
        ...
        policies=[
            [
                dict(
                    type='Resize',
                    img_scale=[(480, 2300), (512, 2300), 
                            (544, 2300), (576, 2300), (608, 2300), (640, 2300), 
                            (672, 2300), (704, 2300), (736, 2300), (768, 2300), 
                            (800, 2300), (832, 2300), (864, 2300), (896, 2300), 
                            (928, 2300), (960, 2300), (992, 2300), (1024, 2300),
                            (1056, 2300), (1088, 2300), (1120, 2300), (1152, 2300),
                            (1184, 2300), (1216, 2300), (1248, 2300), (1280, 2300)],
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/tsr/TSLR_det_Front_GAC_train_V272_tsign_sh30_coco.json',
        img_prefix='',
        pipeline=train_pipeline),
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/tsr/TSLR_det_Front_GAC_test_V22_refine_new_tsr_sh30_coco.json',
        img_prefix='',
