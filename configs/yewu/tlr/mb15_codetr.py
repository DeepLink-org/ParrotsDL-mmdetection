...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/tlr/TSLR_det_Front_GAC_train_V272_tlight_sh30_coco.json',
        img_prefix='',
        pipeline=train_pipeline),
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/mnt/lustre/zongzhuofan/data/tlr/TSLR_det_Front_GAC_test_V22_refine_new_tlr_sh30_coco.json',
        img_prefix='',
