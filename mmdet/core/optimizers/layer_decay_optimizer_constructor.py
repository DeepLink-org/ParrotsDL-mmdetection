    ...
    def add_params(self, params, module, **kwargs):
        ...
        for name, param in module.named_parameters():
            ...
            if 'layer_wise' in decay_type:
                if 'CBXMNet' in module.backbone.__class__.__name__:
                    ...
                    layer_id = get_layer_id_for_codet(
                        name, self.paramwise_cfg.get('num_layers'))
                    logger.info(f'set param {name} as id {layer_id}')                
                elif 'Swin' in module.backbone.__class__.__name__:
                    layer_id = get_layer_id_for_swin(
                        name, self.paramwise_cfg.get('num_layers'))
                    logger.info(f'set param {name} as id {layer_id}')
                elif 'XMNet' in module.backbone.__class__.__name__:
                    layer_id = get_layer_id_for_swin(
                        name, self.paramwise_cfg.get('num_layers'))
                    logger.info(f'set param {name} as id {layer_id}')
                elif 'ConvNeXt' in module.backbone.__class__.__name__:
